...
void NhapCTHD(int x,int y,char &pn,bool mode,CTHoaDon &cthd,NodeHoaDon * &hd,NodeVatTu *dsvt,DSNhanVien dsnv)
{
	...
	cthd.MAVT = PrintdsVatTu(dsvt,dsvt,dsnv,1);
...
void ThemMoiCTHoaDon(NodeHoaDon *&hoadon,NodeVatTu * dsvt,DSNhanVien dsnv)
{
    int  x = 167 ; int y = 26;
    char pn = 17;
    ...
    Caption(captionCTHD,SizeofCaptionCTHD,x,y);
    CTHoaDon cthd;
    NhapCTHD(x,y,pn,0,cthd,hoadon,dsvt,dsnv);
    if(pn==ENTER)
    {
...
void ChinhSuaCTHoaDon(NodeHoaDon *&hoadon,NodeVatTu *dsvt,DSNhanVien dsnv)
{
    int  x = 167 ; int y = 26;
    char pn = 17;
    ClearInsideBox(23,39,167,206);//Xoa man hinh edit
    ...
    while(true)
    {
        ...
        mavt = PrintdsVatTu(dsvt,dsvt,dsnv,1);
    ...
    NhapCTHD(x,y,pn,1,cthd,hoadon,dsvt,dsnv);
    if(pn==ENTER)
        {
            nodecthd->Data = cthd;
...
void DeleleCTHoaDon(NodeHoaDon *&hoadon,NodeVatTu *dsvt,DSNhanVien dsnv)
{
    string mavt;
    NodeCTHoaDon * cthd;
    while(true)
...
void ChiTietHoaDon(int x, int y,NodeVatTu *dsvt,NodeHoaDon *hoadon,char pn,NhanVien *&nhanvien,DSNhanVien dsnv )
{

    if(pn==ENTER)
    {
        ClearFunction();
        ThemMoiCTHoaDon(hoadon,dsvt,dsnv);
        while(true)
        {
            ...
            switch(pn)
            {
                case INS: ThemMoiCTHoaDon(hoadon,dsvt,dsnv);break;
                case DEL: DeleleCTHoaDon(hoadon,dsvt,dsnv);break;
                case F2 : ChinhSuaCTHoaDon(hoadon,dsvt,dsnv);break;
...
void NhapHoaDon(int x, int y,char &pn,bool mode,NodeHoaDon *hoadon,DSNhanVien dsnv,NodeVatTu *dsvt,NhanVien *&nhanvien)
{
	bool check = true;
    ...
    while(true)
    {
        ...
        else
        {
            ...
            if(chon==3) {
                    ChiTietHoaDon(x+20,y+chon*2,dsvt,hoadon,pn,nhanvien,dsnv);
                    InHoaDon(x,y,hoadon->Data, *nhanvien);
            }
        ...
        switch(chon)
        {
            ...
            case 3:ChiTietHoaDon(x+20,y+chon*2,dsvt,hoadon,pn,nhanvien,dsnv);break;
...
void ThemMoiHoaDon(NhanVien *&nhanvien,NodeVatTu * dsvt,DSNhanVien dsnv)
{
    int  x = 167 ; int y = 26;
    char pn = 17;
    ...
    NhapHoaDon(x,y,pn,0,newhoadon,dsnv,dsvt,nhanvien);
    if(pn==ENTER)
    {
